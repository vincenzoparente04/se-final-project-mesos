...
public class TurnOrderTile {
    ...
    /**
     *  Places the player's totem on the first free slot of the TurnOrderTile and applies the effect of that slot.
    ...
    /**
     *  Finds the first free slot on the TurnOrderTile. It filters the list of slots to find the
    ...
    /**
     *  Returns the list of players in the order determined by the occupied slots.
